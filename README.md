...
```
We decided to exclude (S and O ), as the first had very few sequences relative to the smallest clade (< 10 % to GV) and the second represented unclassified isolates. 
